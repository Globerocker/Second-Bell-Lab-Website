...
const Blog: React.FC<BlogProps> = ({ setPage, selectPost }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {featuredPost && (
          <div 
            ...
            className="group cursor-pointer mb-20 animate-fade-up"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {remainingPosts.map((post) => (
            <div 
              ...
              className="group cursor-pointer flex flex-col h-full border-b border-slate-100 pb-8 hover:border-brand-gold transition-colors"
            >
