  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <div className="bg-brand-navy text-white py-24 text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20"></div>
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200 mb-16">
            ...
            <div className="bg-slate-50 p-8 border-t border-slate-200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format&fit=crop" className="rounded-xl shadow-md hover:scale-105 transition-transform duration-500 object-cover h-48 w-full" alt="Lounge" />
                    <img src="https://images.unsplash.com/photo-1580261450046-d0a30080dc9b?q=80&w=2009&auto=format&fit=crop" className="rounded-xl shadow-md hover:scale-105 transition-transform duration-500 object-cover h-48 w-full" alt="Library" />
                    <img src="https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&w=2069&auto=format&fit=crop" className="rounded-xl shadow-md hover:scale-105 transition-transform duration-500 object-cover h-48 w-full" alt="Dojo" />
                    <img src="https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2070&auto=format&fit=crop" className="rounded-xl shadow-md hover:scale-105 transition-transform duration-500 object-cover h-48 w-full" alt="Meeting Room" />
                </div>
            </div>
        </div>
