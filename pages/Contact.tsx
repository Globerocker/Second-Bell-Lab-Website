                            ...
                            <div className="border-l-0 md:border-l-2 border-slate-200 md:pl-6 text-center md:text-left">
                                ...
                                <div className="text-slate-600 text-sm space-y-1">
                                    <p className="flex items-center justify-center md:justify-start gap-2">
                                        ...
                                        <span className="font-bold text-brand-navy">Second Bell Lab LLC</span>
                                    </p>
                                    <p className="flex items-center justify-center md:justify-start gap-2">
                                        <i className="fa-solid fa-phone text-slate-400"></i> +1 (520) 994-8344
                                    </p>
                                    <p className="flex items-center justify-center md:justify-start gap-2">
                                        <i className="fa-solid fa-globe text-slate-400"></i> www.secondbelllab.com
                                    </p>
                                </div>
