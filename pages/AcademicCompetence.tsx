  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="relative h-[60vh] overflow-hidden bg-brand-navy">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-40 scale-105 animate-pulse-slow"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-brand-navy/70 via-brand-navy/50 to-slate-50"></div>
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
          <span className="bg-brand-navy/20 backdrop-blur-md border border-white/10 text-brand-gold font-black tracking-[0.4em] uppercase text-[10px] px-6 py-2 rounded-full mb-8 animate-fade-in shadow-2xl">Pillar 02 • Deep Work</span>
          <h1 className="text-6xl md:text-9xl font-black text-brand-navy mb-8 animate-fade-up tracking-tighter leading-none uppercase">Academic <br /><span className="text-white italic">Competence</span></h1>
